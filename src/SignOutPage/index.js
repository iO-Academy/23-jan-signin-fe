...
const SignOutPage = ({logOutName, setLogOutName}) => {

    const navigate = useNavigate()
    const handleNameChange = (e) => {
        setLogOutName(e.target.value)
    }
        ...
        <>
            ...
            <section className="px-40 py-20 bg-gray-100 mx-10">
                <form action="/" method="PUT" onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="bg-black text-white px-10 mt-10 py-5 text-xl tracking-widest hover:bg-white hover:text-black rounded" disabled={logOutName !== '' ? false : true}>Sign Out</button>
                </form>
